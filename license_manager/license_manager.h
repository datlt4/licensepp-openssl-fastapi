...
struct licenseInfo
{
    licenseInfo(std::string &licenseeSignature, std::string &licensee, std::string &secret, std::string &authorityId,
                std::string &additionalPayload, unsigned int period)
        : licenseeSignature{licenseeSignature}, licensee{licensee}, secret{secret}, authorityId{authorityId},
          additionalPayload{additionalPayload}, period{period}
    {
    }
    licenseInfo()
    {
