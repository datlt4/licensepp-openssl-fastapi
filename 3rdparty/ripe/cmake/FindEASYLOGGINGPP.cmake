...
#
# If ${EASYLOGGINGPP_USE_STATIC_LIBS} is ON then static libs are searched. In
# these cases ${EASYLOGGINGPP_LIBRARY} is also defined
#
# (c) 2017 Amrayn Web Services
#
# https://github.com/amrayn/easyloggingpp https://amrayn.com
# https://muflihun.com
#
...
find_package_handle_standard_args(EASYLOGGINGPP
                                  REQUIRED_VARS EASYLOGGINGPP_INCLUDE_DIR)
